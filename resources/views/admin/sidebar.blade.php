<div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{url('addfoodmenu')}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
                    <span class="menu-title">AddFoodMenu</span>
                </a>
            </li>
            <li class="nav-item menu-items">
              ...
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
                    ...
                    <span class="menu-title">ShowFoodMenu</span>
                </a>
            </li>
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{url('show_addchefs')}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
            ...
            <li class="nav-item menu-items">
                <a class="nav-link" href="{{url('showchefs')}}">
              <span class="menu-icon">
                <i class="mdi mdi-file-document-box"></i>
              </span>
