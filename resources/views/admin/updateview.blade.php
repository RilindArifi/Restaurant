...
<div class="container-fluid page-body-wrapper">
    <div class="container ">
        <form class="form border-2" action="{{url('updatemenu',$data->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            <h1 class="title1">Edit Food Menu</h1>
            ...
            <div class="form-group">
                ...
                <img height="150px" width="150px" src="/menuimage/{{$data->image}}" alt=""><br><br><br>
            </div>
