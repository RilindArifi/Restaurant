                            ...
                            <li>
                                @if (Route::has('login'))
                                    <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                                        ...
                                        @else
                                            <li><a href="{{ route('login') }}" style="color: firebrick" class="dark:text-gray-500 underline ">Log in</a></li>

                                            @if (Route::has('register'))
                                                <li><a href="{{ route('register') }}" style="color: firebrick" class=" ml-4 text-sm text-gray-700 dark:text-gray-500 underline">Register</a></li>
                                            @endif
                                        @endauth
                                    </div>
                                @endif
